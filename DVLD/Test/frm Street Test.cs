...
namespace DVLD.Test
{
    public partial class frm_Street_Test : Form
    {
        private Local_Dl_Business.clsApInfo _AP = new Local_Dl_Business.clsApInfo();
        public frm_Street_Test(Local_Dl_Business.clsApInfo AP)
        {
            InitializeComponent();
            _AP = AP;
        }
        ...
        {
            return Local_Dl_Business.CheckIfHaveAppointment(_AP.LDL_ID, "3");
        }
        ...
        {
            dataGridView1.DataSource = Local_Dl_Business.GetAllTestAppointments(_AP.LDL_ID, "3");
        }
        ...
        private void frm_Street_Test_Load(object sender, EventArgs e)
        {
            _SetControlValue();
            _UpdateDataGrid();
            _UpdateRecords();
        ...
        private void takeTestToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (!_IsLocked())
            {
                FrmTakeTest frm = new FrmTakeTest(_AP, "3");
                frm.ShowDialog();
                _UpdateDataGrid();
                _UpdateRecords();
            }
        ...
        private void editToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (!_IsLocked())
            {
                frmUpdateTestAppointments frm = new frmUpdateTestAppointments(_AP, "3");
                frm.ShowDialog();
                _UpdateDataGrid();
                _UpdateRecords();
            }
        ...
        private void buttonAddNewAppointments_Click(object sender, EventArgs e)
        {
            ...
            {
                if (Local_Dl_Business.IsPassedTest(_AP.LDL_ID, "3"))
                {
                ...
                {
                    frmAddTestAppointments frm = new frmAddTestAppointments(_AP, "3");
                    frm.ShowDialog();
                    _UpdateDataGrid();
                    _UpdateRecords();
                }
