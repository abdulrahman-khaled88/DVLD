...
namespace DVLD.Test
{
    public partial class frmWrittenTest : Form
    {
        ...
        public frmWrittenTest(Local_Dl_Business.clsApInfo AP)
        {
            InitializeComponent();
            _AP = AP;
        }
        ...
        {
            return Local_Dl_Business.CheckIfHaveAppointment(_AP.LDL_ID, "2");
        }
        ...
        {
            dataGridView1.DataSource = Local_Dl_Business.GetAllTestAppointments(_AP.LDL_ID, "2");
        }
        ...
        private void takeTestToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            if (!_IsLocked())
            {
                FrmTakeTest frm = new FrmTakeTest(_AP, "2");
                frm.ShowDialog();
                _UpdateDataGrid();
                _UpdateRecords();
            }
        ...
        private void editToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            if (!_IsLocked())
            {
                frmUpdateTestAppointments frm = new frmUpdateTestAppointments(_AP, "2");
                frm.ShowDialog();
                _UpdateDataGrid();
                _UpdateRecords();
            }
        ...
        private void buttonAddNewAppointments_Click_1(object sender, EventArgs e)
        {
            if (!_CheckIfHaveAppointments())
            {
                if (Local_Dl_Business.IsPassedTest(_AP.LDL_ID, "2"))
                {
                ...
                {
                    frmAddTestAppointments frm = new frmAddTestAppointments(_AP,"2");
                    frm.ShowDialog();
                    _UpdateDataGrid();
                    _UpdateRecords();
                }
